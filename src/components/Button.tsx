...
const Button = () => {
    ...
    return (
        <a className="bg-rose-600 text-white px-4 py-2 rounded-md font-medium no-underline flex items-center gap-2 text-base w-full sm:w-min" href="mailto:hello@dereje.fr">
            <div className={`relative w-full sm:w-[130px] overflow-hidden h-6 flex items-center ${isTransitioning ? 'opacity-0 transition-opacity ease-in-out' : ''}`}>
